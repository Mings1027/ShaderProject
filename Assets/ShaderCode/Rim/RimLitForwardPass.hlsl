...
half4 LitPassFragment(Varyings input): SV_Target
{
    ...
    half rim = FresnelEffect(inputData.normalWS, inputData.viewDirectionWS, _RimPower);
    float NdotL = dot(inputData.normalWS, GetMainLight().direction);
    half4 rimColor = mul(_RimBrightness, step(0.1, NdotL * rim)) * _RimColor;
